...
- **GitHub**: [`teamspace-first-skills`](https://github.com/teamspace-ai-all/teamspace-first-skills) 레포에 PR 제출 (`submissions/{닉네임}/스킬명/`)
...
- **Onboarding셀**: 런칭 체크리스트 생성기, 워크스페이스 세팅 현황 대시보드, Enterprise 도입 전 QA 자동화
